...
const baseCriticalChance = 0.25;
const baseStatusChance = 0.49;
...
const numberOfGladiatorMods = 1; // number of mods equipped from the Gladiator set, each giving 0.1 crit chance bonus
const gladiatorBonus = numberOfGladiatorMods * 0.1; // total crit chance bonus from Gladiator mods
...
const finalCriticalChanceGalSteel = (0, utils_1.roundTo)(100 * baseCriticalChance * (1 + galvanizedSteelBonus + rivenCritBonus + bloodRushBonus + gladiatorBonus), 1);
const finalCriticalChanceSacSteel = (0, utils_1.roundTo)(100 * baseCriticalChance * (1 + sacrificialSteelBonus + rivenCritBonus + bloodRushBonus + gladiatorBonus), 1);
...
const finalHeavyCriticalChanceGalSteel = (0, utils_1.roundTo)(100 * baseCriticalChance * (1 + galvanizedSteelBonus * 2 + rivenCritBonus + bloodRushHeavyBonus + gladiatorBonus), 1);
const finalHeavyCriticalChanceSacSteel = (0, utils_1.roundTo)(100 * baseCriticalChance * (1 + sacrificialSteelBonus * 2 + rivenCritBonus + bloodRushHeavyBonus + gladiatorBonus), 1);
// Final status chance with all modifiers applied rounded to 1 decimal place
const finalStatusChance = (0, utils_1.roundTo)(100 * baseStatusChance * (1 + galvanizedElementalistBonus + weepingWoundsBonus + rivenStatusBonus + bonusFrom6060Mods), 1);
